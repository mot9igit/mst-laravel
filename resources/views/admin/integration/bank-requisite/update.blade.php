        ...
        <div class="row">
            <div class="col-sm-12">
                <ol class="breadcrumb">
                    ...
                    <li class="breadcrumb-item active" aria-current="page">Редактирование банковских реквизитов</li>
                </ol>
            </div>
            <div class="col-sm-12"><h3 class="mb-0">Редактирование банковских реквизитов</h3></div>
        </div>
    </div>
@endsection
@section('content')
    <div class="card card-primary card-outline mb-4">
        <create-bank-requisite-component :org_id="{{ $organization->id }}" :requisite_id="{{ $requisite->id }}" :bank_requisite_id="{{ $bank_requisite->id }}"></create-bank-requisite-component>
    </div>
@endsection
